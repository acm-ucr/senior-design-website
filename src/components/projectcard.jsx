...
const ProjectCard = ({ project }) => {
  ...
  return (
    <div className="flex-col justify-self-center justify-center items-center shadow-2xl  min-w-96 h-full w-96  rounded-md md:w-5/6 lg:w-7/12 sm:w-5/6 px-24 py-12">
      <Image
        src={icon}
        alt={projectName}
